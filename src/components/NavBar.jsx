  ...
  return (
    <div className=' bg-[#1c2a33] w-full h-14 sticky py-2 top-0 z-10'>
       <div className='w-[86%] ml-7 md:ml-28 md:w-[80%] flex justify-between items-center py-2'>
          <h1 className='text-2xl font-bold text-white z-20'>NYAMBOS</h1>
          ...
          <div className= ' md:flex justify-center items-center hidden   '>
            <ul className= ' flex gap-3 items-center z-20 '>
                <li className='text-xl text-white  cursor-pointer hover:text-gray-700 '>Home</li>
                <li className='text-xl text-white  cursor-pointer hover:text-gray-700 '>About</li>
                <li className='text-xl text-white  cursor-pointer hover:text-gray-700 ' >Gallary</li>
                <li className='text-xl text-white   cursor-pointer hover:text-gray-700 '>Contact</li>
            </ul>
          </div>

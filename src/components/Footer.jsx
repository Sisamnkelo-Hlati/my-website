    ...
    <div className='bg-[#1c2a33] w-full h-full flex flex-col items-center py-[1rem] px-[1rem] '>
     ...
     <div className='md:max-w-[1190px] w-full mx-auto px-2 py-8 h-full'>
      ...
      <div className='text-gray-300'>
          <h1 className='text-2xl font-bold uppercase mb-2'>DZUDZU</h1>  
        <p className='text-gray-300 font-semibold text-xl md:w-60 leading-7 tracking-wide'> Data science analyst and software developer </p>
       ...
       <ul className='md:flex flex-col  gap-2  text-base md:text-xl '>
            <li className='text-gray-300 text-sm md:text-base mb-2 flex items-center gap-x-2'><HiMail className='text-xl text-gray-300 '/> hlatisisamnkelo@gmail.com</li>
            <li className='text-gray-300 text-sm md:text-base mb-2 flex items-center gap-x-2'><FaPhone className='text-sm text-gray-300'/> +27 78-270-4967</li>

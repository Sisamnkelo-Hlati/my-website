        ...
        <div
         ...
         <div className='grid sm:grid-cols-2 sm:gap-3 mt-4 md:px-20'>
            ...
            <h2 className=' text-xl text-gray-300 font-bold tracking-wide  mb-3 uppercase'>Software Development</h2>
              <p  className='text-gray-300 max-w-[280px] mx-auto'>Application of Javascript (React, Tailwindcss, nodejs, expressjs, mongoDB ect.) to inhence the site reconciliation submission process at head office and improve compliance levels thereof. </p>
            </div>
              </div>
